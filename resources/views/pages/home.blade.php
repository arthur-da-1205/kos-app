                                ...
                                <a href="details.html" class="card">
                                    <div
                                        ...
                                        <div class="flex flex-col gap-3">
                                            ...
                                            <hr class="border-[#F1F2F6]">
                                            <p class="font-semibold text-lg text-ngekos-orange">Rp {{$popularData->price}}<span
                        ...
                        <a href="details.html" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-3 w-full">
                                    ...
                                    <hr class="border-[#F1F2F6]">
                                    <p class="font-semibold text-lg text-ngekos-orange">Rp {{$boardingHouse->price}}
                                        <span
