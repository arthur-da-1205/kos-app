    ...
    <div id="Categories" class="swiper w-full overflow-x-hidden mt-[30px]">
                        ...
                        <a href="categories.html" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-[2px]">
                                    ...
                                    <p class="text-sm text-ngekos-grey">{{$category->boardingHouse->count()}}</p>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <section id="Popular" class="flex flex-col gap-4">
            ...
            <div class="swiper w-full overflow-x-hidden">
                <div class="swiper-wrapper">
                    @foreach ($populars as $popularData )
                            ...
                            <a href="details.html" class="card">
                                <div
                                    ...
                                    <div class="flex w-full h-[150px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                        <img src="{{asset('storage/' . $popularData->thumbnail)}}" class="w-full h-full object-cover"
                                            alt="thumbnail">
                                    </div>
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <div class="flex items-center gap-[6px]">
                                            <img src="assets/images/icons/location.svg" class="w-5 h-5 flex shrink-0"
                                                alt="icon">
                                            <p class="text-sm text-ngekos-grey">{{$popularData->city->name}}</p>
                                        </div>
                                        <div class="flex items-center gap-[6px]">
                                            <img src="assets/images/icons/3dcube.svg" class="w-5 h-5 flex shrink-0"
                                                alt="icon">
                                            <p class="text-sm text-ngekos-grey">In {{$popularData->category->name}}</p>
                                        </div>
                                        <div class="flex items-center gap-[6px]">
                                        ...
                                        <hr class="border-[#F1F2F6]">
                                        <p class="font-semibold text-lg text-ngekos-orange">Rp {{number_format($popularData->price,0, ',', '.')}}<span
                ...
                @foreach ($cities as $city)
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-[2px]">
                            ...
                            <p class="text-sm text-ngekos-grey">Total {{$city->boardingHouse->count()}}</p>
                        </div>
                    </div>
                    </a>
                @endforeach
                    ...
                    <a href="details.html" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-3 w-full">
                                ...
                                <hr class="border-[#F1F2F6]">
                                <p class="font-semibold text-lg text-ngekos-orange">Rp {{number_format($popularData->price,0, ',', '.')}}
                                    <span
                                        class="text-sm text-ngekos-grey font-normal">/bulan
                                    </span>
                                </p>
                            </div>
                        </div>
